...
This tool parses real live streams from streaming platforms and plays them via **PotPlayer** on Windows. Currently supporting Huya (huya.com), Douyin (live.douyin.com), Douyu (douyu.com), and Bilibili (live.bilibili.com), it reconstructs each platform's stream-signing algorithm while fixing a Huya disconnection issue that occurred around every 2 minutes.
